-- ============================================
-- SKMM Web - Fix: Drop & Recreate with camelCase
...
-- 1. JOBS TABLE (camelCase columns)
CREATE TABLE jobs (
  id TEXT PRIMARY KEY,
  title TEXT NOT NULL,
  titleKhmer TEXT,
...
('news-1', 'Batch 18 Departs for Kansai International Airport — ពិធីជូនដំណើរកម្មសិក្សាការីជំនាន់ទី១៨', '12 Sep, 2026', 'departures', 'Departures', 'Editorial Staff', '3 min read', 'SKMM Group and the Ministry of Labour successfully hosted the pre-departure sendoff ceremony for 24 Cambodian technical interns and SSW workers heading to Osaka and Kyoto medical facilities.', '<p>SKMM Investment Group, in close coordination with the Ministry of Labour and Vocational Training (MoLVT), successfully hosted the official pre-departure sendoff ceremony for 24 Cambodian technical interns and Specified Skilled Workers heading to Osaka and Kyoto.</p><br><p>All 24 candidates completed 6 months of intensive Japanese language immersion and cultural acclimatization at HANABI Center, achieving JLPT N4 and JFT-Basic A2 credentials. The candidates are placed in nursing care and precision agriculture sectors.</p><br><p>CEO of SKMM Group delivered an encouraging speech reminding candidates to maintain high work ethics, embrace Japanese craftsmanship, and make Cambodia proud.</p>'),
('news-2', 'Landmark MOU Signed with Tokyo Healthcare Alliance — ការចុះកិច្ចព្រមព្រៀងសហប្រតិបត្តិការ', '28 Aug, 2026', 'partnership', 'Partnership', 'PR Division', '2 min read', 'Strategic memorandum signed in Tokyo to train and deploy up to 100 Cambodian Certified Caregivers annually under the Specified Skilled Worker (SSW 1) program with full Japanese scholarships.', '<p>A landmark Memorandum of Understanding (MOU) was signed between SKMM Investment Group and Tokyo Wellness & Medical Alliance in Tokyo. Under this agreement, SKMM will prepare and deploy up to 100 Certified Caregiving Specialists annually under the Specified Skilled Worker (SSW) visa program.</p><br><p>The program includes sponsored scholarships for advanced nursing Japanese and guaranteed subsidized accommodation upon arrival in Japan.</p>'),
('news-3', 'HANABI Center Students Achieve 94% Pass Rate in JLPT July 2026 — លទ្ធផលប្រឡងភាសាជប៉ុន', '10 Aug, 2026', 'campus', 'Campus Life', 'Academic Dean', '2 min read', 'Official results released for July JLPT test: HANABI students set a record 94% pass rate across N5, N4, and N3 levels, with 18 candidates earning N3 diplomas in just 8 months.', '<p>The official results for the July 2026 Japanese Language Proficiency Test (JLPT) were announced, with HANABI Training Center students recording an unprecedented 94% pass rate across N5, N4, and N3 levels.</p><br><p>18 candidates achieved N3 certification within their first 8 months of study, qualifying them for higher managerial and supervisory roles in Japanese corporations.</p>'),
('news-4', 'Joint Interview Session with Ibaraki Agricultural Cooperative — សម្ភាសន៍ផ្ទាល់ជាមួយក្រុមហ៊ុនជប៉ុន', '24 Jul, 2026', 'interviews', 'Interviews', 'Recruitment Team', '3 min read', 'Japanese employer delegation conducted two days of in-person technical interviews and tractor dexterity evaluations at SKMM campus, selecting 28 skilled agricultural candidates.', '<p>Delegates from Ibaraki Agricultural Cooperative visited the SKMM Phnom Penh Headquarters for a two-day direct recruitment and practical evaluation session.</p><br><p>35 candidates participated in live tractor handling, soil preparation assessments, and formal Japanese interviews. 28 candidates were officially selected on the spot.</p>'),
('news-5', 'Annual Japanese Cultural Matsuri & Speech Contest 2026 — ទិវាវប្បធម៌ជប៉ុន និងការប្រកួតសុន្ទរកថា', '15 Jul, 2026', 'campus', 'Campus Life', 'Student Council', '2 min read', 'Over 250 trainees and guests joined the lively summer Tanabata festival featuring traditional Yukata dress, Japanese Taiko drumming, and inspiring Japanese speech competitions.', '<p>Over 250 trainees, senseis, and visiting Japanese partner delegates gathered at HANABI Center for the 2026 Summer Matsuri. The event featured traditional Yukata dress workshops, Taiko drumming, and an inspiring speech competition won by Ms. Sokha on her aspirations to support elderly care in Kobe.</p>'),
('news-6', 'MoLVT Inspection Team Commends SKMM Campus Compliance — គណៈប្រតិភូក្រសួងការងារចុះត្រួតពិនិត្យ', '02 Jun, 2026', 'partnership', 'Partnership', 'Legal Affairs', '2 min read', 'Senior officials from the Department of Employment and Manpower praised SKMM''s strict adherence to ethical recruitment, dormitory sanitation, and high safety standards.', '<p>Senior inspection delegates from the Department of Employment and Manpower of Cambodia conducted a comprehensive routine assessment of SKMM facilities. The delegation awarded high commendations for dormitory cleanliness, zero broker fees, transparent candidate accounts, and professional caregiving simulation laboratories.</p>');
...
('SKMM-0821', 'Sokha M.', 'SM', 'female', 'N3', 'caregiving', 'Caregiving (ចេញព្រះអាយ)', '23 Years', '2 yrs Hospital Assistant', 'Yes (Car & Motorbike)', 'Recorded (Self-Intro)', 'Available', 'status-available'),
('SKMM-0822', 'Vireak K.', 'VK', 'male', 'N4', 'agriculture', 'Agriculture (កសិកម្ម)', '26 Years', '3 yrs Hydroponic Farm', 'Yes (Tractor / Auto)', 'Recorded (Farm skills)', 'Available', 'status-available'),
('SKMM-0823', 'Chanthy P.', 'CP', 'female', 'N4', 'food', 'Food Processing (ផលិតចំណីអាហារ)', '22 Years', '1 yr Food Packaging Line', 'No', 'Recorded (Hygiene test)', 'Interviewing', 'status-interviewing'),
('SKMM-0824', 'Dara T.', 'DT', 'male', 'N4', 'construction', 'Construction (សំណង)', '25 Years', '2 yrs Scaffolding / Civil', 'Yes (Forklift / Machinery)', 'Recorded (Safety drill)', 'Available', 'status-available'),
('SKMM-0825', 'Bopha L.', 'BL', 'female', 'N3', 'hospitality', 'Hospitality (សណ្ឋាគារ)', '24 Years', '2 yrs Boutique Hotel Reception', 'No', 'Recorded (Customer Care)', 'Available', 'status-available'),
('SKMM-0826', 'Rithy S.', 'RS', 'male', 'N4', 'livestock', 'Livestock Farming (ចិញ្ចឹមសត្វ)', '27 Years', '3 yrs Cattle & Poultry', 'Driver License Type B', 'Recorded (Practical)', 'Selected', 'status-selected');
